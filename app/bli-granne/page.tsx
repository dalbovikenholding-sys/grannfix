            ...
            {[
              {
                ...
                titel: 'BankID',
                text: 'Du behöver ett giltigt BankID för att verifiera din identitet.',
              },
              {
                icon: (
                  <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#1a6b3c" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                ...
                titel: 'Minst 18 år',
                text: 'Du måste vara myndig för att ta uppdrag på Grannfix.',
              },
              {
                icon: (
                  <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#1a6b3c" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                ...
                titel: 'Norrbotten',
                text: 'Du behöver bo eller befinna dig i Norrbottens län för att ta uppdrag.',
              },
            ].map(k => (
              <div key={k.titel} className="bg-white rounded-2xl p-8 text-center shadow-sm border border-gray-100">
                <div className="flex justify-center mb-4">
                  <div className="w-14 h-14 bg-[#f0faf4] rounded-2xl flex items-center justify-center">
                    {k.icon}
                  </div>
                </div>
